...
//thats why I have a counter variable and I count the number of read chars. So I pass it to ft_leftstr to null terminate the buf2 at the exact point. (I could have done that in the below function but the limitation of norminete didn't allow me!) 
